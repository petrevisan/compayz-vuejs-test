...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Desafio Vue.js NoTyped","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_08cc1876 === 'function') {
    await nuxt_plugin_plugin_08cc1876(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_0aa856bb === 'function') {
    await nuxt_plugin_bootstrapvue_0aa856bb(app.context, inject)
  }
